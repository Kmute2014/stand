...
import { LayoutDashboard, MessageSquare, Smile, Users, Clock, Edit3, History, LogOut, Settings, Lock, KanbanSquare, Menu, X, Ticket } from 'lucide-react';
  ...
  const navItems = [
    ...
    },
    {
      group: 'Project Management', items: [
        ...
        { id: 'jira', label: 'JIRA', icon: <Ticket className="w-4 h-4 opacity-80 current-icon" /> },
      ]
    },
    {
      group: 'Admin', items: [
